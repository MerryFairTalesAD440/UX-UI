...
export default {
  ...
  beforeMount(){
    axios({ method: "POST", "url": "https://ad440-dev-function.azurewebsites.net/v1/sastoken/", "data": {'container': 'merryfairytalesassets'}, "headers": {'Content-Type': 'application/json'}})
  ...
  created() {
        ...
        //if (this.book.pages[this.myNumber-1].image_url !== null) {
          this.book.pages[this.myNumber-1].languages.audio_url = "https://ad440oneboxtempbb81.blob.core.windows.net/getsastoken/"+this.myFileNameA;
